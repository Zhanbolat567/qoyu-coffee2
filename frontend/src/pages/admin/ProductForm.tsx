...
export default function ProductForm() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const [cats, gs] = await Promise.all([api.get("/categories"), api.get("/options/groups")]);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[160px,1fr] gap-6">
          <div>
            ...
            <label className="mt-2 block">
              <span className="inline-block px-3 py-2 rounded-lg border bg-white hover:bg-gray-50 cursor-pointer">Выбрать изображение</span>
